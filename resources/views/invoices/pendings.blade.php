                    ...
                    <table class="table table-hover" id="providers">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <button class="btn btn-rounded btn-xs btn-primary mb-3" value="{{$item->id}}" OnClick="Emit(this);"><i class="fa fa-check"></i> Emitir</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
...
<script type="text/javascript">
    ...
    function Emit(btn) {
        var id = btn.value;
        var route = "/facturas/emitir/" + btn.value;
        swal({
            title: '¿Estás seguro?',
            text: "Esta factura pasara a estatus EMITIDA",
            type: 'warning',
                ...
                return new Promise(function (resolve) {
                    ...
                    $.ajax({
                        ...
                        .done(function (response) {
                            location.reload();
                            swal('Emitida!', response.message, response.status);
                        })
                        .fail(function () {
