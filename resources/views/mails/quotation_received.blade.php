...
<head>
    ...
    <title>ViajateMX | Confirmación</title>
                                ...
                                <table style="margin:0 auto;" cellspacing="0" cellpadding="0" width="100%">
                                    <tr>
                                        <td style="text-align: center;">
                                            <a href="#"><img class="w320" width="100" height="83" src="{{asset('/images/logotipo.png')}}"
                                                    alt="company logo" /></a>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td style="background-color:#3bcdb0;">
                                            ...
                                            <table cellspacing="0" cellpadding="0" class="force-full-width">
                                                <tr>
                                                    <td style="font-size:40px; font-weight: 600; color: #ffffff; text-align:center;"
                                                        ...
                                                        Hemos recibido tu solicitud de cotización exitosamente!
                                                        <br />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="font-size:24px; text-align:center; padding: 0 75px; color: #6f6f6f;"
                                                        ...
                                                        Te informamos que nuestro equipo se encuentra trabajando en tu
                                                        solicitud para poder mandarte los detalles a la brevedad.
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('/quoting/assets/img/bg_1.jpg')}}" style="max-width:100%; display:block;">
                                                    </td>
                                                </tr>
                                            </table>
                                ...
                                <table cellspacing="0" cellpadding="0" bgcolor="#363636" class="force-full-width">
                                    ...
                                    <tr>
                                        <td style="color:#f0f0f0; font-size: 14px; text-align:center; padding-bottom:4px;">
                                            © 2018 Todos los derechos son reservados
                                        </td>
                                    </tr>
                                    <tr>
